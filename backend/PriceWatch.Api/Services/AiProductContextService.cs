...
// Purpose:
//   Builds factual V10.3 AI product context by combining ProductConfig with scraper
//   latest snapshot and compact history files, plus lightweight purchase/archive context.
//   Suspicious/failed latest candidates are never used as accepted current prices.
...
//
// Outputs:
//   IReadOnlyList<AiProductContext> containing authoritative accepted facts for AI.
//   History is chronological oldest -> newest so V10.3 TREND is correct. This
//   service does not decide BUY/WAIT/NEUTRAL.
// ============================================================================
...
public sealed class AiProductContextService
{
    ...
    )
    {
        ...
        foreach (var config in selected)
        {
            ...
            var acceptedHistoryDescending = history
            ...
            result.Add(new AiProductContext
            {
                ...
                PriceStatus = currentIsAccepted ? "success" : "accepted_history",
